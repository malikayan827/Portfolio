  ...
  return (
    ...
    max-w-3xl leading-[30px]"
      >
        ...
        <button type="button" class="text-white bg-tertiary hover:underline transition-all duration-1000 focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">  My resume</button>
        </a>
      </motion.p>
